...
public class SOP_Inverse {
    ...
    public static String SOP_Inverse_Generation(int[] index){
    StringBuilder sb = new StringBuilder();
    sb.append(Canonical_SOP.SOP_generation_byIndex(SOP_Inverse.getInverseIndex(index)));
    return sb.toString();
    }
